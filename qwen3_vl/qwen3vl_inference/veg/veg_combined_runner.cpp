...
private:
    ...
    bool createDevice() {
        ...
        // SDK 2.43 HTP requires explicit SoC model, arch, and PD session configs
        QnnHtpDevice_CustomConfig_t htpSocConfig;
        htpSocConfig.option   = QNN_HTP_DEVICE_CONFIG_OPTION_SOC;
        htpSocConfig.socModel = 72;  // SM8650 / Snapdragon 8 Gen 3
        ...
        htpArchConfig.arch.arch     = QNN_HTP_DEVICE_ARCH_V81;
    ...
    bool loadContextFromBinary() {
        ...
        // Pass HTP context configs (weight sharing + extended UDMA from htp_config.json)
        QnnHtpContext_CustomConfig_t ctxWsCfg;
        ctxWsCfg.option                    = QNN_HTP_CONTEXT_CONFIG_OPTION_WEIGHT_SHARING_ENABLED;
        ctxWsCfg.weightSharingEnabled      = true;

        QnnHtpContext_CustomConfig_t ctxUdmaCfg;
        ctxUdmaCfg.option                  = QNN_HTP_CONTEXT_CONFIG_OPTION_USE_EXTENDED_UDMA;
        ctxUdmaCfg.useExtendedUdma         = true;

        QnnContext_Config_t ctxCfg0 = {QNN_CONTEXT_CONFIG_OPTION_CUSTOM, {&ctxWsCfg}};
        QnnContext_Config_t ctxCfg1 = {QNN_CONTEXT_CONFIG_OPTION_CUSTOM, {&ctxUdmaCfg}};
        const QnnContext_Config_t* ctxConfigs[] = {&ctxCfg0, &ctxCfg1, nullptr};
